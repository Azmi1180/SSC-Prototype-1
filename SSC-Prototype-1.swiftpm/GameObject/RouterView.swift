...
struct RouterView: View {
    ...
    var body: some View {
        ZStack {
            // HAPUS Background Color agar transparan di atas game
    ...
    func wifiWaves() -> some View {
        ...
        // Hanya muncul gelombang kalau menu terbuka (atau kondisi lain yg kamu mau)
